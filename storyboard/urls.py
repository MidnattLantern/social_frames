...
#    path('project/episode', views.RenderEpisodeView.as_view(), name='episode_url_path'),
#    path('project/episode/scene', views.RenderSceneView.as_view(), name='scene_url_path'),
]