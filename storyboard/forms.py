...
class CreateEpisodeItem(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['episode_name'].widget.attrs[
            'placeholder'] = 'Max 50 characters'
...
class CreateSceneItem(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['scene_name'].widget.attrs[
            'placeholder'] = 'Max 50 characters'
        self.fields['scene_chronology'].widget.attrs[
            'placeholder'] = '___'
        self.fields['scene_event_notes'].widget.attrs[
...
class CreateSketchItem(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['sketch_name'].widget.attrs[
            'placeholder'] = 'Max 50 characters'
        self.fields['sketch_artist'].widget.attrs[
            'placeholder'] = 'Max 50 characters'
...
class CommentSketchItem(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['sketch_directors_comment'].widget.attrs[
            'placeholder'] = 'Max 300 characters'
